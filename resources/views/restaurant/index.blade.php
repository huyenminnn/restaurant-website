			...
			<li>
				<div class="slider-caption">
					...
					<p>Donec justo dui, semper vitae aliquam euzali, ornare pretium enim. Maecenas molestie diam
						<br><br>eget tellus luctus fermentum.
					</p>
					<a href="single-post.html">Shop Now</a>
				</div>
				<img src="{{ asset('restaurant/images/slide1.jpg') }}" alt="" />
			</li>
			<li>
				<div class="slider-caption">
				...
				<img src="{{ asset('restaurant/images/slide2.jpg') }}" alt="" />
			</li>
			<li>
				<div class="slider-caption">
					<h1>Healthy Drinks</h1>
					<p>Maecenas fermentum est ut elementum vulputate. Ut vel consequat urna. Ut aliquet 
						<br><br>ornare massa, quis dapibus quam condimentum id.
					</p>
					<a href="single-post.html">Get Ready</a>
				</div>
				<img src="{{ asset('restaurant/images/slide3.jpg') }}" alt="" />
			</li>
		</ul>
	</div>
</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-sm-6">
				<div class="blog-post">
					<div class="blog-thumb">
						<img src="{{ asset('restaurant/images/blogpost1.jpg') }}" alt="" />
					</div>
			...
			<div class="col-md-4 col-sm-6">
				<div class="blog-post">
					<div class="blog-thumb">
						<img src="{{ asset('restaurant/images/blogpost2.jpg') }}" alt="" />
					</div>
					<div class="blog-content">
						<div class="content-show">
			...
			<div class="col-md-4 col-sm-6">
				<div class="blog-post">
					<div class="blog-thumb">
						<img src="{{ asset('restaurant/images/blogpost3.jpg') }}" alt="" />
					</div>
					<div class="blog-content">
						<div class="content-show">
			...
			<div class="col-md-4 col-sm-6">
				<div class="blog-post">
					<div class="blog-thumb">
						<img src="{{ asset('restaurant/images/blogpost4.jpg') }}" alt="" />
					</div>
					<div class="blog-content">
						<div class="content-show">
			...
			<div class="col-md-4 col-sm-6">
				<div class="blog-post">
					<div class="blog-thumb">
						<img src="{{ asset('restaurant/images/blogpost5.jpg') }}" alt="" />
					</div>
					<div class="blog-content">
						<div class="content-show">
			...
			<div class="col-md-4 col-sm-6">
				<div class="blog-post">
					<div class="blog-thumb">
						<img src="{{ asset('restaurant/images/blogpost6.jpg') }}" alt="" />
					</div>
					<div class="blog-content">
						<div class="content-show">
